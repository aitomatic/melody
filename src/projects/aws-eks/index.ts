...
for (const policyArn of [
    ...
    new aws.iam.RolePolicyAttachment(`aitomatic-eks-ng-role-policy-${counter++}`,
        { policyArn, role },
    );
}
...
const managedNodeGroup = eks.createManagedNodeGroup("aitomatic-eks-ng", {
    cluster: cluster,
...
const autoScalerChart = new k8s.helm.v3.Chart("aisys-as", {
    version: "9.10.7",
